...
@section('titre', 'Equipements en Maintenance')

@section('content')
    <div id="content" class="content">
        <ol class="breadcrumb float-xl-right">
            <li class="breadcrumb-item">
                <a href="#modal-add-equipement" class="btn btn-sm btn-dark text-white" data-toggle="modal">Planifier une maintenance</a>
            </li>

            <li id="btn-show-liste-user" class="breadcrumb-item">
                <a href="#" class="btn btn-sm btn-dark text-white">Historique des Maintenances</a>
            </li>
        </ol>
        ...
        <div id="table-liste-user" class="panel panel-inverse">
            ...
            <div class="panel-heading">
                <h4 class="panel-title">Liste Equipements en maintenance</h4>
                    ...
                    <tbody>
                        @forelse($equipements as $index => $equipement)
                            <tr class="odd gradeX">
                                ...
                                <!-- Statut -->
                                <td class="text-center">
                                    <span class="badge bg-danger">{{ $equipement->statut }}</span>
                                </td>
                        ...
                        @empty
                            <p class="alert alert-danger text-center h4 fw-bold">Aucun équipement en maintenance pour le moment.</p>
                        @endforelse
                    </tbody>
                </table>
            </div>
