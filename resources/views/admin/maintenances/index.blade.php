                ...
                <table id="data-table-default" class="table table-striped table-bordered table-td-valign-middle">
                    <thead>
                        <tr>
                            ...
                            <th class="text-nowrap text-center">Utilisateur</th>
                    ...
                    <tbody>
                        @forelse($maintenances as $index => $maintenance)
                            <tr class="odd gradeX">
                                ...
                                <!-- Utilisateur -->
                                <td class="text-center">
                                    {{ $maintenance->user->prenom }} {{ $maintenance->user->name }}
                                </td>
                                ...
                                <td class="text-center">
                                    ...
                                    <a href="#" class="btn-detail-maintenance" data-id="{{ $maintenance->id }}"
                                        data-utilisateur="{{ $maintenance->user->prenom }} {{ $maintenance->user->name }}"
                                    ...
                                    @if ($maintenance->statut !== 'terminée')
                                        ...
                                        <a href="#" class="btn-edit-maintenance" data-toggle="modal"
                                            ...
                                            data-user-id="{{ $maintenance->user_id }}"
                                            ...
                                            data-action="{{ route('admin.maintenances.update', $maintenance->id) }}"
                                        ...
                                        <form id="delete-maintenance-form-{{ $maintenance->id }}"
                                            action="{{ route('admin.maintenances.destroy', $maintenance->id) }}"
                                            method="POST" style="display: none;">
                                            @csrf
                                            @method('DELETE')
                                        </form>
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <form id="planifierMaintenanceForm" action="{{ route('admin.maintenances.store') }}"
                        method="post">
                        @csrf

                        <!-- Technicien -->
                        <div class="mb-3">
                            <label for="maintenance-technicien" class="form-label">Technicien <span class="text-danger">*</span></label>
                            <select name="user_id" id="maintenance-technicien" class="form-control" required>
                                <option value="">-- Sélectionner un technicien --</option>
                                @foreach($techniciens as $technicien)
                                    <option value="{{ $technicien->id }}">
                                        {{ $technicien->prenom }} {{ $technicien->name }}
                                    </option>
                                @endforeach
                            </select>
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <form id="editMaintenanceForm" method="POST">
                        ...
                        <!-- Technicien -->
                        <div class="mb-3">
                            <label for="edit-maintenance-technicien" class="form-label">Technicien <span class="text-danger">*</span></label>
                            <select name="user_id" id="edit-maintenance-technicien" class="form-control" required>
                                <option value="">-- Sélectionner un technicien --</option>
                                @foreach($techniciens as $technicien)
                                    <option value="{{ $technicien->id }}">
                                        {{ $technicien->prenom }} {{ $technicien->name }}
            ...
            <div class="modal-content shadow border-0">
                ...
                <div class="modal-body">
                    <div class="row">
                        ...
                        <div class="col-12">
                            <h4 id="detail-maintenance-utilisateur" class="text-primary fw-bold mb-3"></h4>

                            <p>
                                <strong>Equipements :</strong><br>
                                <span id="detail-maintenance-equipement" class="text-muted"></span>
                            </p>
